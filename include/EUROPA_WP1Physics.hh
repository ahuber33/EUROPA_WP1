#ifndef EUROPA_WP1Physics_h
#define EUROPA_WP1Physics_h 1

/**
 * @class EUROPA_WP1Physics
 ...
 * Example usage:
 * @code
 * auto physicsList = new EUROPA_WP1Physics();
 * runManager->SetUserInitialization(physicsList);
 * @endcode
 */
class EUROPA_WP1Physics final : public G4VModularPhysicsList
{
public:
    ...
    /// Destructor
    ~EUROPA_WP1Physics() override;

};

#endif // EUROPA_WP1Physics_h
