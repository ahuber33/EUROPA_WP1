#ifndef EUROPA_WP1PrimaryGeneratorAction_h
#define EUROPA_WP1PrimaryGeneratorAction_h 1
...
class EUROPA_WP1PrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
public:
     ...
     */
    EUROPA_WP1PrimaryGeneratorAction(size_t N, size_t numThreads, bool pMT);
...
private:
     ...
     */
    static void ShowProgress(double progress, std::chrono::high_resolution_clock::time_point startTime);
