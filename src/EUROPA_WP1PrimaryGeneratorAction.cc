/**
 * @file EUROPA_WP1PrimaryGeneratorAction.cc
 * @brief Implementation of the primary generator action for the PALLAS simulation.
 *
 * This file implements the `EUROPA_WP1PrimaryGeneratorAction` class, which handles
 ...
 */
EUROPA_WP1PrimaryGeneratorAction::EUROPA_WP1PrimaryGeneratorAction(size_t N, size_t numThreads, G4bool pMT)
    : NEventsGenerated(N),
 ...
 */
EUROPA_WP1PrimaryGeneratorAction::~EUROPA_WP1PrimaryGeneratorAction()
{
  delete particleGun;
 ...
 */
void EUROPA_WP1PrimaryGeneratorAction::ShowProgress(
 ...
 */
void EUROPA_WP1PrimaryGeneratorAction::GeneratePrimaries(G4Event *anEvent)
{
  ...
  if (threadID == 0)
    {
      ShowProgress(static_cast<double>(currentParticleNumber) / double(NEventsGenerated), startTime);
    }
