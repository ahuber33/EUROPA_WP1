/**
 * @file EUROPA_WP1Physics.cc
 * @brief Implementation of the EUROPA_WP1Physics custom physics list.
 *
 * This file implements the `EUROPA_WP1Physics` class, a custom physics list
 ...
 *
 * Usage:
 *  - Instantiate `EUROPA_WP1Physics` and set it as the physics list in
 ...
 */
EUROPA_WP1Physics::EUROPA_WP1Physics()
{
