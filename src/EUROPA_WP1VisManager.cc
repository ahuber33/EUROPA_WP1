/**
 * @file EUROPA_WP1VisManager.cc
 * @brief Implementation of the EUROPA_WP1VisManager visualization manager.
 * @author Arnaud HUBER <huber@lp2ib.in2p3.fr>
 * @date 2026
 * @copyright EUROPA Project - WP1
 * This file defines the methods for the `EUROPA_WP1VisManager` class,
...
#include "EUROPA_WP1VisManager.hh"
...
// Constructor
// ============================================================
EUROPA_WP1VisManager::EUROPA_WP1VisManager() {}
 ...
 *  - Uncomment both its `#include` line and its `RegisterGraphicsSystem(...)` call.
 */
void EUROPA_WP1VisManager::RegisterGraphicsSystems()
{
    ...
    // === ToolSSG (X11 GLES) ===
    #ifdef G4VIS_USE_TOOLSSG_X11_GLES
    RegisterGraphicsSystem(new G4ToolSSGX11GLES); ///< Preferred for modern OpenGL ES rendering
    #endif
